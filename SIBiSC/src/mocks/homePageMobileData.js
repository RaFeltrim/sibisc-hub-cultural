...
export const mockHomeContent = {
  sections: [
    {
      ...
      subtitle: 'Assistente em protótipo para dúvidas, recomendações e orientação no SIBiSC.',
    },
    {
      id: 'quick-actions',
      type: 'actions',
  ...
  latestNews: [
    ...
    {
      id: 'n3',
      title: 'Programação do Dia do Livro 2026 é divulgada',
      excerpt: 'Semana de atividades gratuitas aproxima leitura, escolas e bibliotecas.',
